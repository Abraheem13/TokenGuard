...
### GENSEEDS_aime24_avg8.md
  ...
  AGREE                0.423 ± 0.071  46.1 ± 4.6
  DEER                 0.653 ± 0.045  2.2 ± 1.4
  MUR-mom              0.422 ± 0.071  20.1 ± 3.7
  NTC-conf             0.645 ± 0.044  3.4 ± 0.7
  NTC-full(e=0.01)     0.642 ± 0.044  4.0 ± 1.2
  REFRAIN-SWUCB        0.569 ± 0.046  20.3 ± 3.4

### GENSEEDS_aime25_avg8.md
  vanilla              0.459 ± 0.066  0.0 ± 0.0
  AGREE                0.365 ± 0.050  45.6 ± 3.3
  DEER                 0.464 ± 0.058  1.9 ± 1.1
  MUR-mom              0.412 ± 0.067  14.4 ± 1.7
  NTC-conf             0.463 ± 0.057  1.6 ± 0.4
  NTC-full(e=0.01)     0.453 ± 0.054  6.2 ± 2.0
  REFRAIN-SWUCB        0.431 ± 0.057  18.8 ± 2.2

### GENSEEDS_gpqa16k_Qwen3-4B.md
  vanilla              0.503 ± 0.011  0.0 ± 0.0
  AGREE                0.334 ± 0.023  66.7 ± 0.9
  DEER                 0.500 ± 0.012  5.0 ± 2.4
  MUR-mom              0.484 ± 0.025  12.5 ± 0.5
  NTC-conf             0.492 ± 0.014  6.3 ± 2.4
  NTC-full(e=0.01)     0.483 ± 0.008  12.1 ± 1.8
  REFRAIN-SWUCB        0.454 ± 0.002  29.7 ± 1.2

### GENSEEDS_gpqa16k_Qwen3-8B.md
  vanilla              0.538 ± 0.033  0.0 ± 0.0
  AGREE                0.356 ± 0.025  67.0 ± 1.3
  DEER                 0.532 ± 0.030  3.6 ± 1.2
  MUR-mom              0.503 ± 0.014  13.3 ± 1.1
  NTC-conf             0.527 ± 0.030  2.8 ± 0.8
  NTC-full(e=0.01)     0.512 ± 0.027  9.5 ± 2.6
  REFRAIN-SWUCB        0.527 ± 0.025  6.7 ± 0.7
...
### GENSEEDS_mmlupro_Qwen3-4B.md
  vanilla              0.301 ± 0.008  0.0 ± 0.0
  AGREE                0.278 ± 0.003  37.6 ± 1.3
  DEER                 0.289 ± 0.008  25.5 ± 4.0
  MUR-mom              0.300 ± 0.003  9.4 ± 0.8
  NTC-conf             0.296 ± 0.004  7.0 ± 2.6
  NTC-full(e=0.01)     0.293 ± 0.005  13.1 ± 3.4
  REFRAIN-SWUCB        0.268 ± 0.009  59.3 ± 0.3

### GENSEEDS_mmlupro_Qwen3-8B.md
  vanilla              0.329 ± 0.006  0.0 ± 0.0
  AGREE                0.305 ± 0.006  35.0 ± 4.5
  DEER                 0.322 ± 0.004  10.9 ± 2.2
  MUR-mom              0.325 ± 0.007  11.9 ± 1.3
  NTC-conf             0.329 ± 0.006  10.2 ± 0.2
  NTC-full(e=0.01)     0.323 ± 0.006  18.2 ± 3.1
  REFRAIN-SWUCB        0.322 ± 0.003  15.2 ± 0.7
