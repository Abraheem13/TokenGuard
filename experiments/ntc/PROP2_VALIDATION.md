...
| mmlu_pro/Qwen3-4B | 0.219 | 0.647 | 0.031 | 0.056 | -0.5 | 200 |
| mmlu_pro/Qwen3-8B | 0.177 | 0.623 | 0.020 | 0.081 | -1.0 | 200 |
...
n = 12 settings.
Spearman(P_spur, lost-correct risk) = +0.818 (positive supports Prop. 2).
Spearman(P_spur, AGREE delta) = -0.699 (negative supports Prop. 2).
